...
def lambda_handler(event, context):
    ...
    output_json_path = ('RTOFS_OCEAN_CURRENTS_3D/' + formatted_folder_date + '/' + str(model_level_depth) + 'm/json/' +
        'rtofs_currents_' + formatted_folder_date + '.json')

    output_pickle_path = ('RTOFS_OCEAN_CURRENTS_3D/' + formatted_folder_date + '/' + str(model_level_depth) + 'm/pickle/' +
